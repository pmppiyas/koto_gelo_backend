...
export class PersonalExpenseController {
  ...
  async create(
    ...
    const result = await this.personalExpenseService.create(user.id, body);
  ...
  async findAll(
    ...
    const result = await this.personalExpenseService.findAll(user.id, query);
  ...
  async findOne(
    ...
    const result = await this.personalExpenseService.findOne(user.id, id);
  ...
  async update(
    ...
    const result = await this.personalExpenseService.update(
      user.id,
      id,
      body,
    );
  ...
  async remove(
    ...
    const result = await this.personalExpenseService.remove(user.id, id);
